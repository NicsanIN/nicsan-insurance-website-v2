...
const MotorInsuranceCard: React.FC<MotorInsuranceCardProps> = ({ onBookSafetyCall }) => {
  ...
  return (
    <div className="relative motor-card-container">
      {/* Simple Motor Insurance Card - Following Figma Design */}
      <div 
        className={`relative w-full h-[120px] sm:h-[140px] lg:h-[160px] bg-light-gray rounded-[12px] sm:rounded-[16px] p-3 sm:p-4 motor-card-base cursor-pointer transition-all duration-200 ${
