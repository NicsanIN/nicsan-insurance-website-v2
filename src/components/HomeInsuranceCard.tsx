...
const HomeInsuranceCard: React.FC<HomeInsuranceCardProps> = ({ onBookSafetyCall }) => {
  ...
  return (
    <div className="relative home-card-container">
      {/* Simple Home Insurance Card - Following Figma Design */}
      <div 
        className={`relative w-full h-[120px] sm:h-[140px] lg:h-[160px] bg-light-gray rounded-[12px] sm:rounded-[16px] p-3 sm:p-4 home-card-base cursor-pointer transition-all duration-200 ${
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div>
            ...
            <p className="font-satoshi font-normal text-xs sm:text-sm text-gray-600 leading-tight">
              Make your castle disaster-proof
            </p>
          </div>
        </div>
      </div>
