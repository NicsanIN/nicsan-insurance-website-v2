...
const CyberInsuranceCard: React.FC<CyberInsuranceCardProps> = ({ onBookSafetyCall }) => {
  ...
  return (
    <div className="relative cyber-card-container">
      {/* Simple Cyber Insurance Card - Following Figma Design */}
      <div 
        className={`relative w-full h-[120px] sm:h-[140px] lg:h-[160px] bg-light-gray rounded-[12px] sm:rounded-[16px] p-3 sm:p-4 cyber-card-base cursor-pointer transition-all duration-200 ${
